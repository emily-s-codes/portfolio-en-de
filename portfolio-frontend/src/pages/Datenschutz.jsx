...
const Datenschutz = ({ english }) => {
    return (
        <main className="datenschutzMain">
            ...
            <section>
                <h3>{english ? "Data subject rights" : "Betroffenenrechte"}</h3>
                <p>{english ? "" : ""} </p>
            </section>
            <section>
                <h3>{english ? "Third-party plugins" : "Plugins von Drittanbietenden"}</h3>
                <p>{english ? "Easy, I don't use any." : "Ganz einfach, ich verwende keine."} </p>
            </section>
            <section>
                <h3>{english ? "Commissioned service providers used" : "eingesetzte Auftragsdienstleistende"}</h3>
                <p>{english ? "Easy, I don't use any." : "Ganz einfach, ich verwende keine."} </p>
            </section>
            <section>
                <h3>Cookies</h3>
